...
from oarepo_communities.services.permissions.generators import DefaultCommunityRole


def test_default_community_role_needs(
...
def test_default_community_role_query_filter(
    app,
    db,
